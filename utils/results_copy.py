...
FOCUS_ORDER_TITLE = "Focus order sensitivity"
FOCUS_ORDER_DISCLAIMER = (
    "Behavioural sensitivity to focus ordering — not mechanistic attention. "
    "Global permutation associations are exploratory; position sweeps are controlled interventions."
)
